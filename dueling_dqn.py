...
#    train_steps = 1000000
    ...
    with tf.variable_scope('obstacle_avoiding'):
        dueling_DQN = DuelingDQN2(
            action_size=ACTION_SPACE, rate=0.7,state=state_size, epsilon=0.5, memory_size=MEMORY_SIZE,
...
#    saver.restore(sess,"/home/zhw/gym-gazebo/examples/turtlebot/dueling_dqn/training/images/obstacle/"+str(4250)+".ckpt")#reload parameters
...
#                done = True
        ...
        if e % 250 == 0:            
            save_path = saver.save(sess, "/home/zhw/gym-gazebo/examples/turtlebot/dueling_dqn/training/images/obstacle/"+str(e)+".ckpt")
            np.save('total_reward.npy',treward)
        if total_reward > 5:
            save_path = saver.save(sess, "/home/zhw/gym-gazebo/examples/turtlebot/dueling_dqn/training/images/obstacle/good/"+str(e)+".ckpt")
        if e % 500 == 0:
