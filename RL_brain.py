...
#                        outputs_collections=net_param,
                    ...
                    V_fc2 = tf.contrib.layers.dropout(
                        inputs = V_fc1,
                        keep_prob=1.0,
                        noise_shape=None,
...
#                        outputs_collections=net_param,
                    ...
                    A_fc2 = tf.contrib.layers.dropout(
                        inputs = A_fc1,
                        keep_prob=1.0,
                        noise_shape=None,
                        is_training=self.train,
...
# for batch learning, high memory requirement but less time_consuming
...
# for sequential learning, low memory requirement but very time-consuming
        minibatch = random.sample(self.memory, self.batch_size)
